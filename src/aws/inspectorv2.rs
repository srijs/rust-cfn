...
/// The [`AWS::InspectorV2::CisScanConfiguration`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-inspectorv2-cisscanconfiguration.html) resource type.
#[derive(Debug, Default)]
pub struct CisScanConfiguration {
    properties: CisScanConfigurationProperties
}

/// Properties for the `CisScanConfiguration` resource.
#[derive(Debug, Default)]
pub struct CisScanConfigurationProperties {
    /// Property [`ScanName`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-inspectorv2-cisscanconfiguration.html#cfn-inspectorv2-cisscanconfiguration-scanname).
    ///
    /// Update type: _Mutable_.
    /// AWS CloudFormation doesn't replace the resource when you change this property.
    pub scan_name: Option<::Value<String>>,
    /// Property [`Schedule`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-inspectorv2-cisscanconfiguration.html#cfn-inspectorv2-cisscanconfiguration-schedule).
    ///
    /// Update type: _Mutable_.
    /// AWS CloudFormation doesn't replace the resource when you change this property.
    pub schedule: Option<::Value<self::cis_scan_configuration::Schedule>>,
    /// Property [`SecurityLevel`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-inspectorv2-cisscanconfiguration.html#cfn-inspectorv2-cisscanconfiguration-securitylevel).
    ///
    /// Update type: _Mutable_.
    /// AWS CloudFormation doesn't replace the resource when you change this property.
    pub security_level: Option<::Value<String>>,
    /// Property [`Tags`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-inspectorv2-cisscanconfiguration.html#cfn-inspectorv2-cisscanconfiguration-tags).
    ///
    /// Update type: _Mutable_.
    /// AWS CloudFormation doesn't replace the resource when you change this property.
    pub tags: Option<::ValueMap<String>>,
    /// Property [`Targets`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-inspectorv2-cisscanconfiguration.html#cfn-inspectorv2-cisscanconfiguration-targets).
    ///
    /// Update type: _Mutable_.
    /// AWS CloudFormation doesn't replace the resource when you change this property.
    pub targets: Option<::Value<self::cis_scan_configuration::CisTargets>>,
}

impl ::serde::Serialize for CisScanConfigurationProperties {
    fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
        let mut map = ::serde::Serializer::serialize_map(s, None)?;
        if let Some(ref scan_name) = self.scan_name {
            ::serde::ser::SerializeMap::serialize_entry(&mut map, "ScanName", scan_name)?;
        }
        ...
        if let Some(ref security_level) = self.security_level {
            ::serde::ser::SerializeMap::serialize_entry(&mut map, "SecurityLevel", security_level)?;
        }
...
impl<'de> ::serde::Deserialize<'de> for CisScanConfigurationProperties {
    fn deserialize<D: ::serde::Deserializer<'de>>(d: D) -> Result<CisScanConfigurationProperties, D::Error> {
        struct Visitor;

        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            type Value = CisScanConfigurationProperties;

            fn expecting(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
                write!(f, "a struct of type CisScanConfigurationProperties")
            }

            fn visit_map<A: ::serde::de::MapAccess<'de>>(self, mut map: A) -> Result<Self::Value, A::Error> {
                let mut scan_name: Option<::Value<String>> = None;
                let mut schedule: Option<::Value<self::cis_scan_configuration::Schedule>> = None;
                let mut security_level: Option<::Value<String>> = None;
                let mut tags: Option<::ValueMap<String>> = None;
                let mut targets: Option<::Value<self::cis_scan_configuration::CisTargets>> = None;

                while let Some(__cfn_key) = ::serde::de::MapAccess::next_key::<String>(&mut map)? {
                    match __cfn_key.as_ref() {
                        "ScanName" => {
                            scan_name = ::serde::de::MapAccess::next_value(&mut map)?;
                        }
                        "Schedule" => {
                            schedule = ::serde::de::MapAccess::next_value(&mut map)?;
                        }
                        "SecurityLevel" => {
                            security_level = ::serde::de::MapAccess::next_value(&mut map)?;
                        }
                        "Tags" => {
                ...
                Ok(CisScanConfigurationProperties {
                    scan_name: scan_name,
                    schedule: schedule,
...
impl ::Resource for CisScanConfiguration {
    type Properties = CisScanConfigurationProperties;
    const TYPE: &'static str = "AWS::InspectorV2::CisScanConfiguration";
    fn properties(&self) -> &CisScanConfigurationProperties {
        &self.properties
    }
    fn properties_mut(&mut self) -> &mut CisScanConfigurationProperties {
        &mut self.properties
    }
}

impl ::private::Sealed for CisScanConfiguration {}

impl From<CisScanConfigurationProperties> for CisScanConfiguration {
    fn from(properties: CisScanConfigurationProperties) -> CisScanConfiguration {
        CisScanConfiguration { properties }
    }
}
...
pub mod cis_scan_configuration {
    //! Property types for the `CisScanConfiguration` resource.

    /// The [`AWS::InspectorV2::CisScanConfiguration.CisTargets`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-inspectorv2-cisscanconfiguration-cistargets.html) property type.
    #[derive(Debug, Default)]
    pub struct CisTargets {
        /// Property [`AccountIds`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-inspectorv2-cisscanconfiguration-cistargets.html#cfn-inspectorv2-cisscanconfiguration-cistargets-accountids).
        ///
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub account_ids: ::ValueList<String>,
        /// Property [`TargetResourceTags`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-inspectorv2-cisscanconfiguration-cistargets.html#cfn-inspectorv2-cisscanconfiguration-cistargets-targetresourcetags).
        ///
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub target_resource_tags: Option<::Value<::json::Value>>,
    }

    impl ::codec::SerializeValue for CisTargets {
        fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
            let mut map = ::serde::Serializer::serialize_map(s, None)?;
            ::serde::ser::SerializeMap::serialize_entry(&mut map, "AccountIds", &self.account_ids)?;
            if let Some(ref target_resource_tags) = self.target_resource_tags {
                ::serde::ser::SerializeMap::serialize_entry(&mut map, "TargetResourceTags", target_resource_tags)?;
            }
            ::serde::ser::SerializeMap::end(map)
        }
    }

    impl ::codec::DeserializeValue for CisTargets {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(d: D) -> Result<CisTargets, D::Error> {
            struct Visitor;

            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                type Value = CisTargets;

                fn expecting(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
                    write!(f, "a struct of type CisTargets")
                }

                fn visit_map<A: ::serde::de::MapAccess<'de>>(self, mut map: A) -> Result<Self::Value, A::Error> {
                    let mut account_ids: Option<::ValueList<String>> = None;
                    let mut target_resource_tags: Option<::Value<::json::Value>> = None;
                    ...
                    while let Some(__cfn_key) = ::serde::de::MapAccess::next_key::<String>(&mut map)? {
                        match __cfn_key.as_ref() {
                            ...
                            "TargetResourceTags" => {
                                target_resource_tags = ::serde::de::MapAccess::next_value(&mut map)?;
                            }
                            _ => {}
                        }
                    }
    ...
    /// The [`AWS::InspectorV2::CisScanConfiguration.DailySchedule`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-inspectorv2-cisscanconfiguration-dailyschedule.html) property type.
    #[derive(Debug, Default)]
    pub struct DailySchedule {
        /// Property [`StartTime`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-inspectorv2-cisscanconfiguration-dailyschedule.html#cfn-inspectorv2-cisscanconfiguration-dailyschedule-starttime).
        ///
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub start_time: ::Value<Time>,
    }

    impl ::codec::SerializeValue for DailySchedule {
        fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
            let mut map = ::serde::Serializer::serialize_map(s, None)?;
    ...
    impl ::codec::DeserializeValue for DailySchedule {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(d: D) -> Result<DailySchedule, D::Error> {
            struct Visitor;
            ...
            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                ...
                fn expecting(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
                    write!(f, "a struct of type DailySchedule")
                }

                fn visit_map<A: ::serde::de::MapAccess<'de>>(self, mut map: A) -> Result<Self::Value, A::Error> {
                    let mut start_time: Option<::Value<Time>> = None;
    ...
    /// The [`AWS::InspectorV2::CisScanConfiguration.MonthlySchedule`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-inspectorv2-cisscanconfiguration-monthlyschedule.html) property type.
    #[derive(Debug, Default)]
    pub struct MonthlySchedule {
        /// Property [`Day`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-inspectorv2-cisscanconfiguration-monthlyschedule.html#cfn-inspectorv2-cisscanconfiguration-monthlyschedule-day).
        ///
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub day: ::Value<String>,
        /// Property [`StartTime`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-inspectorv2-cisscanconfiguration-monthlyschedule.html#cfn-inspectorv2-cisscanconfiguration-monthlyschedule-starttime).
        ///
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub start_time: ::Value<Time>,
    ...
    impl ::codec::SerializeValue for MonthlySchedule {
        fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
            let mut map = ::serde::Serializer::serialize_map(s, None)?;
    ...
    impl ::codec::DeserializeValue for MonthlySchedule {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(d: D) -> Result<MonthlySchedule, D::Error> {
            struct Visitor;
            ...
            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                ...
                fn expecting(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
                    write!(f, "a struct of type MonthlySchedule")
                }
    ...
    /// The [`AWS::InspectorV2::CisScanConfiguration.Schedule`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-inspectorv2-cisscanconfiguration-schedule.html) property type.
    #[derive(Debug, Default)]
    pub struct Schedule {
        /// Property [`Daily`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-inspectorv2-cisscanconfiguration-schedule.html#cfn-inspectorv2-cisscanconfiguration-schedule-daily).
        ///
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub daily: Option<::Value<DailySchedule>>,
        /// Property [`Monthly`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-inspectorv2-cisscanconfiguration-schedule.html#cfn-inspectorv2-cisscanconfiguration-schedule-monthly).
        ///
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub monthly: Option<::Value<MonthlySchedule>>,
        /// Property [`OneTime`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-inspectorv2-cisscanconfiguration-schedule.html#cfn-inspectorv2-cisscanconfiguration-schedule-onetime).
        ///
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub one_time: Option<::Value<::json::Value>>,
        /// Property [`Weekly`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-inspectorv2-cisscanconfiguration-schedule.html#cfn-inspectorv2-cisscanconfiguration-schedule-weekly).
        ///
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub weekly: Option<::Value<WeeklySchedule>>,
    }
    ...
    impl ::codec::SerializeValue for Schedule {
        fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
            ...
            if let Some(ref monthly) = self.monthly {
                ::serde::ser::SerializeMap::serialize_entry(&mut map, "Monthly", monthly)?;
            }
            if let Some(ref one_time) = self.one_time {
                ::serde::ser::SerializeMap::serialize_entry(&mut map, "OneTime", one_time)?;
            }
            if let Some(ref weekly) = self.weekly {
                ::serde::ser::SerializeMap::serialize_entry(&mut map, "Weekly", weekly)?;
            }
            ::serde::ser::SerializeMap::end(map)
        }
    }
    ...
    impl ::codec::DeserializeValue for Schedule {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(d: D) -> Result<Schedule, D::Error> {
            ...
            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(self, mut map: A) -> Result<Self::Value, A::Error> {
                    let mut daily: Option<::Value<DailySchedule>> = None;
                    let mut monthly: Option<::Value<MonthlySchedule>> = None;
                    let mut one_time: Option<::Value<::json::Value>> = None;
                    let mut weekly: Option<::Value<WeeklySchedule>> = None;
                    ...
                    while let Some(__cfn_key) = ::serde::de::MapAccess::next_key::<String>(&mut map)? {
                        match __cfn_key.as_ref() {
                            ...
                            "Monthly" => {
                                monthly = ::serde::de::MapAccess::next_value(&mut map)?;
                            }
                            "OneTime" => {
                                one_time = ::serde::de::MapAccess::next_value(&mut map)?;
                            }
                            "Weekly" => {
                                weekly = ::serde::de::MapAccess::next_value(&mut map)?;
                            }
                            _ => {}
                        }
                    }
    ...
    /// The [`AWS::InspectorV2::CisScanConfiguration.Time`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-inspectorv2-cisscanconfiguration-time.html) property type.
    #[derive(Debug, Default)]
    pub struct Time {
        /// Property [`TimeOfDay`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-inspectorv2-cisscanconfiguration-time.html#cfn-inspectorv2-cisscanconfiguration-time-timeofday).
        ///
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub time_of_day: ::Value<String>,
        /// Property [`TimeZone`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-inspectorv2-cisscanconfiguration-time.html#cfn-inspectorv2-cisscanconfiguration-time-timezone).
        ///
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
    ...
    impl ::codec::SerializeValue for Time {
        fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
            let mut map = ::serde::Serializer::serialize_map(s, None)?;
    ...
    impl ::codec::DeserializeValue for Time {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(d: D) -> Result<Time, D::Error> {
            struct Visitor;
    ...
    /// The [`AWS::InspectorV2::CisScanConfiguration.WeeklySchedule`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-inspectorv2-cisscanconfiguration-weeklyschedule.html) property type.
    #[derive(Debug, Default)]
    pub struct WeeklySchedule {
        /// Property [`Days`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-inspectorv2-cisscanconfiguration-weeklyschedule.html#cfn-inspectorv2-cisscanconfiguration-weeklyschedule-days).
        ///
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub days: ::ValueList<String>,
        /// Property [`StartTime`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-inspectorv2-cisscanconfiguration-weeklyschedule.html#cfn-inspectorv2-cisscanconfiguration-weeklyschedule-starttime).
        ///
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub start_time: ::Value<Time>,
    ...
    impl ::codec::SerializeValue for WeeklySchedule {
        fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
            let mut map = ::serde::Serializer::serialize_map(s, None)?;
    ...
    impl ::codec::DeserializeValue for WeeklySchedule {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(d: D) -> Result<WeeklySchedule, D::Error> {
            struct Visitor;
            ...
            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                ...
                fn expecting(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
                    write!(f, "a struct of type WeeklySchedule")
                }

                fn visit_map<A: ::serde::de::MapAccess<'de>>(self, mut map: A) -> Result<Self::Value, A::Error> {
                    let mut days: Option<::ValueList<String>> = None;
                    let mut start_time: Option<::Value<Time>> = None;
