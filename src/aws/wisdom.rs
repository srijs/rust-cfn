...
pub mod knowledge_base {
    ...
    pub struct AppIntegrationsConfiguration {
        ...
        /// Update type: _Immutable_.
        /// AWS CloudFormation replaces the resource when you change this property.
        pub object_fields: Option<::ValueList<String>>,
    }
    ...
    impl ::codec::SerializeValue for AppIntegrationsConfiguration {
        fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
            ...
            if let Some(ref object_fields) = self.object_fields {
                ::serde::ser::SerializeMap::serialize_entry(&mut map, "ObjectFields", object_fields)?;
            }
            ::serde::ser::SerializeMap::end(map)
        }
    }
    ...
    pub struct SourceConfiguration {
        ...
        /// Update type: _Immutable_.
        /// AWS CloudFormation replaces the resource when you change this property.
        pub app_integrations: ::Value<AppIntegrationsConfiguration>,
    }

    impl ::codec::SerializeValue for SourceConfiguration {
        fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
            let mut map = ::serde::Serializer::serialize_map(s, None)?;
            ::serde::ser::SerializeMap::serialize_entry(&mut map, "AppIntegrations", &self.app_integrations)?;
            ::serde::ser::SerializeMap::end(map)
        }
    }
            ...
            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(self, mut map: A) -> Result<Self::Value, A::Error> {
                    ...
                    Ok(SourceConfiguration {
                        app_integrations: app_integrations.ok_or(::serde::de::Error::missing_field("AppIntegrations"))?,
                    })
                }
            }
