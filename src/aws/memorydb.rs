...
pub struct ClusterProperties {
    ...
    /// Property [`ClusterEndpoint`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-memorydb-cluster.html#cfn-memorydb-cluster-clusterendpoint).
    ///
    /// Update type: _Mutable_.
    /// AWS CloudFormation doesn't replace the resource when you change this property.
    pub cluster_endpoint: Option<::Value<self::cluster::Endpoint>>,
    ...
    /// Property [`DataTiering`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-memorydb-cluster.html#cfn-memorydb-cluster-datatiering).
    ///
    /// Update type: _Immutable_.
    /// AWS CloudFormation replaces the resource when you change this property.
    pub data_tiering: Option<::Value<String>>,
...
impl ::serde::Serialize for ClusterProperties {
    fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(ref data_tiering) = self.data_tiering {
            ::serde::ser::SerializeMap::serialize_entry(&mut map, "DataTiering", data_tiering)?;
        }
    ...
    fn deserialize<D: ::serde::Deserializer<'de>>(d: D) -> Result<ClusterProperties, D::Error> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(self, mut map: A) -> Result<Self::Value, A::Error> {
                ...
                let mut cluster_endpoint: Option<::Value<self::cluster::Endpoint>> = None;
                let mut cluster_name: Option<::Value<String>> = None;
                let mut data_tiering: Option<::Value<String>> = None;
                ...
                while let Some(__cfn_key) = ::serde::de::MapAccess::next_key::<String>(&mut map)? {
                    match __cfn_key.as_ref() {
                        ...
                        "DataTiering" => {
                            data_tiering = ::serde::de::MapAccess::next_value(&mut map)?;
                        }
                        "Description" => {
...
pub mod user {
    ...
    /// The [`AWS::MemoryDB::User.AuthenticationMode`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-memorydb-user-authenticationmode.html) property type.
    #[derive(Debug, Default)]
    pub struct AuthenticationMode {
        /// Property [`Passwords`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-memorydb-user-authenticationmode.html#cfn-memorydb-user-authenticationmode-passwords).
        ///
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub passwords: Option<::ValueList<String>>,
        /// Property [`Type`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-memorydb-user-authenticationmode.html#cfn-memorydb-user-authenticationmode-type).
        ///
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
