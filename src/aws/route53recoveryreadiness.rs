...
pub struct CellProperties {
    ...
    pub cell_name: Option<::Value<String>>,
...
impl ::serde::Serialize for CellProperties {
    fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(ref cell_name) = self.cell_name {
            ::serde::ser::SerializeMap::serialize_entry(&mut map, "CellName", cell_name)?;
        }
...
pub struct ReadinessCheckProperties {
    ...
    /// Update type: _Immutable_.
    /// AWS CloudFormation replaces the resource when you change this property.
    pub readiness_check_name: Option<::Value<String>>,
...
impl ::serde::Serialize for ReadinessCheckProperties {
    fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
        let mut map = ::serde::Serializer::serialize_map(s, None)?;
        if let Some(ref readiness_check_name) = self.readiness_check_name {
            ::serde::ser::SerializeMap::serialize_entry(&mut map, "ReadinessCheckName", readiness_check_name)?;
        }
...
pub struct RecoveryGroupProperties {
    ...
    /// Update type: _Immutable_.
    /// AWS CloudFormation replaces the resource when you change this property.
    pub recovery_group_name: Option<::Value<String>>,
...
impl ::serde::Serialize for RecoveryGroupProperties {
    fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
        ...
        if let Some(ref recovery_group_name) = self.recovery_group_name {
            ::serde::ser::SerializeMap::serialize_entry(&mut map, "RecoveryGroupName", recovery_group_name)?;
        }
        if let Some(ref tags) = self.tags {
            ::serde::ser::SerializeMap::serialize_entry(&mut map, "Tags", tags)?;
        }
