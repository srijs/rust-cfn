...
pub mod job {
    ...
    /// The [`AWS::DataBrew::Job.ParameterMap`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-databrew-job-parametermap.html) property type.
    #[derive(Debug, Default)]
