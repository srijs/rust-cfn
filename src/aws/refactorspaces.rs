...
impl ::serde::Serialize for ApplicationProperties {
    fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
        ...
        ::serde::ser::SerializeMap::serialize_entry(&mut map, "ProxyType", &self.proxy_type)?;
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(self, mut map: A) -> Result<Self::Value, A::Error> {
                ...
                Ok(ApplicationProperties {
                    ...
                    proxy_type: proxy_type.ok_or(::serde::de::Error::missing_field("ProxyType"))?,
                    tags: tags,
...
pub struct EnvironmentProperties {
    ...
    /// Update type: _Immutable_.
    /// AWS CloudFormation replaces the resource when you change this property.
    pub network_fabric_type: ::Value<String>,
...
impl ::serde::Serialize for EnvironmentProperties {
    fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
        ...
        ::serde::ser::SerializeMap::serialize_entry(&mut map, "Name", &self.name)?;
        ::serde::ser::SerializeMap::serialize_entry(&mut map, "NetworkFabricType", &self.network_fabric_type)?;
        if let Some(ref tags) = self.tags {
            ::serde::ser::SerializeMap::serialize_entry(&mut map, "Tags", tags)?;
        }
        ::serde::ser::SerializeMap::end(map)
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(self, mut map: A) -> Result<Self::Value, A::Error> {
                ...
                Ok(EnvironmentProperties {
                    ...
                    name: name.ok_or(::serde::de::Error::missing_field("Name"))?,
                    network_fabric_type: network_fabric_type.ok_or(::serde::de::Error::missing_field("NetworkFabricType"))?,
                    tags: tags,
                })
            }
        }
...
impl ::serde::Serialize for RouteProperties {
    fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
        ...
        ::serde::ser::SerializeMap::serialize_entry(&mut map, "EnvironmentIdentifier", &self.environment_identifier)?;
        ::serde::ser::SerializeMap::serialize_entry(&mut map, "RouteType", &self.route_type)?;
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(self, mut map: A) -> Result<Self::Value, A::Error> {
                ...
                Ok(RouteProperties {
                    ...
                    environment_identifier: environment_identifier.ok_or(::serde::de::Error::missing_field("EnvironmentIdentifier"))?,
                    route_type: route_type.ok_or(::serde::de::Error::missing_field("RouteType"))?,
...
pub mod route {
    ...
    pub struct UriPathRouteInput {
        ...
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub activation_state: ::Value<String>,
        /// Property [`AppendSourcePath`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-refactorspaces-route-uripathrouteinput.html#cfn-refactorspaces-route-uripathrouteinput-appendsourcepath).
        ///
        /// Update type: _Immutable_.
        /// AWS CloudFormation replaces the resource when you change this property.
        pub append_source_path: Option<::Value<bool>>,
    ...
    impl ::codec::SerializeValue for UriPathRouteInput {
        fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
            let mut map = ::serde::Serializer::serialize_map(s, None)?;
            ::serde::ser::SerializeMap::serialize_entry(&mut map, "ActivationState", &self.activation_state)?;
            if let Some(ref append_source_path) = self.append_source_path {
                ::serde::ser::SerializeMap::serialize_entry(&mut map, "AppendSourcePath", append_source_path)?;
            }
    ...
    impl ::codec::DeserializeValue for UriPathRouteInput {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(d: D) -> Result<UriPathRouteInput, D::Error> {
            ...
            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(self, mut map: A) -> Result<Self::Value, A::Error> {
                    let mut activation_state: Option<::Value<String>> = None;
                    let mut append_source_path: Option<::Value<bool>> = None;
                    ...
                    while let Some(__cfn_key) = ::serde::de::MapAccess::next_key::<String>(&mut map)? {
                        match __cfn_key.as_ref() {
                            ...
                            "AppendSourcePath" => {
                                append_source_path = ::serde::de::MapAccess::next_value(&mut map)?;
                            }
                            "IncludeChildPaths" => {
