...
pub struct StackSetProperties {
    ...
    /// Update type: _Mutable_.
    /// AWS CloudFormation doesn't replace the resource when you change this property.
    pub managed_execution: Option<::Value<self::stack_set::ManagedExecution>>,
    ...
    fn deserialize<D: ::serde::Deserializer<'de>>(d: D) -> Result<StackSetProperties, D::Error> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(self, mut map: A) -> Result<Self::Value, A::Error> {
                ...
                let mut managed_execution: Option<::Value<self::stack_set::ManagedExecution>> = None;
...
pub mod stack_set {
    ...
    pub struct DeploymentTargets {
        ...
        /// Property [`AccountsUrl`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudformation-stackset-deploymenttargets.html#cfn-cloudformation-stackset-deploymenttargets-accountsurl).
        ///
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub accounts_url: Option<::Value<String>>,
    ...
    impl ::codec::SerializeValue for DeploymentTargets {
        fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
            ...
            if let Some(ref accounts_url) = self.accounts_url {
                ::serde::ser::SerializeMap::serialize_entry(&mut map, "AccountsUrl", accounts_url)?;
            }
        ...
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(d: D) -> Result<DeploymentTargets, D::Error> {
            ...
            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(self, mut map: A) -> Result<Self::Value, A::Error> {
                    ...
                    let mut accounts_url: Option<::Value<String>> = None;
                    ...
                    while let Some(__cfn_key) = ::serde::de::MapAccess::next_key::<String>(&mut map)? {
                        match __cfn_key.as_ref() {
                            ...
                            "AccountsUrl" => {
                                accounts_url = ::serde::de::MapAccess::next_value(&mut map)?;
                            }
    ...
    /// The [`AWS::CloudFormation::StackSet.ManagedExecution`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudformation-stackset-managedexecution.html) property type.
    #[derive(Debug, Default)]
    pub struct ManagedExecution {
        /// Property [`Active`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cloudformation-stackset-managedexecution.html#cfn-cloudformation-stackset-managedexecution-active).
        ///
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
    ...
    impl ::codec::SerializeValue for ManagedExecution {
        fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
            let mut map = ::serde::Serializer::serialize_map(s, None)?;
    ...
    impl ::codec::DeserializeValue for ManagedExecution {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(d: D) -> Result<ManagedExecution, D::Error> {
            struct Visitor;

            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                type Value = ManagedExecution;

                fn expecting(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
                    write!(f, "a struct of type ManagedExecution")
                }
