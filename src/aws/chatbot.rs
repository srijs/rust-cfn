...
/// The [`AWS::Chatbot::MicrosoftTeamsChannelConfiguration`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-chatbot-microsoftteamschannelconfiguration.html) resource type.
#[derive(Debug, Default)]
pub struct MicrosoftTeamsChannelConfiguration {
    properties: MicrosoftTeamsChannelConfigurationProperties
}

/// Properties for the `MicrosoftTeamsChannelConfiguration` resource.
#[derive(Debug, Default)]
pub struct MicrosoftTeamsChannelConfigurationProperties {
    /// Property [`ConfigurationName`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-chatbot-microsoftteamschannelconfiguration.html#cfn-chatbot-microsoftteamschannelconfiguration-configurationname).
    ///
    /// Update type: _Immutable_.
    /// AWS CloudFormation replaces the resource when you change this property.
    pub configuration_name: ::Value<String>,
    /// Property [`GuardrailPolicies`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-chatbot-microsoftteamschannelconfiguration.html#cfn-chatbot-microsoftteamschannelconfiguration-guardrailpolicies).
    ///
    /// Update type: _Mutable_.
    /// AWS CloudFormation doesn't replace the resource when you change this property.
    pub guardrail_policies: Option<::ValueList<String>>,
    /// Property [`IamRoleArn`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-chatbot-microsoftteamschannelconfiguration.html#cfn-chatbot-microsoftteamschannelconfiguration-iamrolearn).
    ///
    /// Update type: _Mutable_.
    /// AWS CloudFormation doesn't replace the resource when you change this property.
    pub iam_role_arn: ::Value<String>,
    /// Property [`LoggingLevel`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-chatbot-microsoftteamschannelconfiguration.html#cfn-chatbot-microsoftteamschannelconfiguration-logginglevel).
    ///
    /// Update type: _Mutable_.
    /// AWS CloudFormation doesn't replace the resource when you change this property.
    pub logging_level: Option<::Value<String>>,
    /// Property [`SnsTopicArns`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-chatbot-microsoftteamschannelconfiguration.html#cfn-chatbot-microsoftteamschannelconfiguration-snstopicarns).
    ///
    /// Update type: _Mutable_.
    /// AWS CloudFormation doesn't replace the resource when you change this property.
    pub sns_topic_arns: Option<::ValueList<String>>,
    /// Property [`TeamId`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-chatbot-microsoftteamschannelconfiguration.html#cfn-chatbot-microsoftteamschannelconfiguration-teamid).
    ///
    /// Update type: _Immutable_.
    /// AWS CloudFormation replaces the resource when you change this property.
    pub team_id: ::Value<String>,
    /// Property [`TeamsChannelId`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-chatbot-microsoftteamschannelconfiguration.html#cfn-chatbot-microsoftteamschannelconfiguration-teamschannelid).
    ///
    /// Update type: _Mutable_.
    /// AWS CloudFormation doesn't replace the resource when you change this property.
    pub teams_channel_id: ::Value<String>,
    /// Property [`TeamsTenantId`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-chatbot-microsoftteamschannelconfiguration.html#cfn-chatbot-microsoftteamschannelconfiguration-teamstenantid).
    ///
    /// Update type: _Immutable_.
    /// AWS CloudFormation replaces the resource when you change this property.
    pub teams_tenant_id: ::Value<String>,
    /// Property [`UserRoleRequired`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-chatbot-microsoftteamschannelconfiguration.html#cfn-chatbot-microsoftteamschannelconfiguration-userrolerequired).
    ///
    /// Update type: _Mutable_.
    /// AWS CloudFormation doesn't replace the resource when you change this property.
...
impl ::serde::Serialize for MicrosoftTeamsChannelConfigurationProperties {
    fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
        ...
        ::serde::ser::SerializeMap::serialize_entry(&mut map, "TeamsChannelId", &self.teams_channel_id)?;
        ::serde::ser::SerializeMap::serialize_entry(&mut map, "TeamsTenantId", &self.teams_tenant_id)?;
...
impl<'de> ::serde::Deserialize<'de> for MicrosoftTeamsChannelConfigurationProperties {
    fn deserialize<D: ::serde::Deserializer<'de>>(d: D) -> Result<MicrosoftTeamsChannelConfigurationProperties, D::Error> {
        struct Visitor;

        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            type Value = MicrosoftTeamsChannelConfigurationProperties;

            fn expecting(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
                write!(f, "a struct of type MicrosoftTeamsChannelConfigurationProperties")
            }
            ...
            fn visit_map<A: ::serde::de::MapAccess<'de>>(self, mut map: A) -> Result<Self::Value, A::Error> {
                ...
                let mut teams_channel_id: Option<::Value<String>> = None;
                let mut teams_tenant_id: Option<::Value<String>> = None;
                ...
                while let Some(__cfn_key) = ::serde::de::MapAccess::next_key::<String>(&mut map)? {
                    match __cfn_key.as_ref() {
                        ...
                        "TeamsChannelId" => {
                            teams_channel_id = ::serde::de::MapAccess::next_value(&mut map)?;
                        }
                        "TeamsTenantId" => {
                            teams_tenant_id = ::serde::de::MapAccess::next_value(&mut map)?;
                        }
                        "UserRoleRequired" => {
                ...
                Ok(MicrosoftTeamsChannelConfigurationProperties {
                    ...
                    teams_channel_id: teams_channel_id.ok_or(::serde::de::Error::missing_field("TeamsChannelId"))?,
                    teams_tenant_id: teams_tenant_id.ok_or(::serde::de::Error::missing_field("TeamsTenantId"))?,
...
impl ::Resource for MicrosoftTeamsChannelConfiguration {
    type Properties = MicrosoftTeamsChannelConfigurationProperties;
    const TYPE: &'static str = "AWS::Chatbot::MicrosoftTeamsChannelConfiguration";
    fn properties(&self) -> &MicrosoftTeamsChannelConfigurationProperties {
        &self.properties
    }
    fn properties_mut(&mut self) -> &mut MicrosoftTeamsChannelConfigurationProperties {
        &mut self.properties
    }
}

impl ::private::Sealed for MicrosoftTeamsChannelConfiguration {}

impl From<MicrosoftTeamsChannelConfigurationProperties> for MicrosoftTeamsChannelConfiguration {
    fn from(properties: MicrosoftTeamsChannelConfigurationProperties) -> MicrosoftTeamsChannelConfiguration {
        MicrosoftTeamsChannelConfiguration { properties }
    }
}
