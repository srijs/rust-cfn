...
/// The [`AWS::FSx::DataRepositoryAssociation`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-fsx-datarepositoryassociation.html) resource type.
#[derive(Debug, Default)]
pub struct DataRepositoryAssociation {
    properties: DataRepositoryAssociationProperties
}

/// Properties for the `DataRepositoryAssociation` resource.
#[derive(Debug, Default)]
pub struct DataRepositoryAssociationProperties {
    /// Property [`BatchImportMetaDataOnCreate`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-fsx-datarepositoryassociation.html#cfn-fsx-datarepositoryassociation-batchimportmetadataoncreate).
    ///
    /// Update type: _Immutable_.
    /// AWS CloudFormation replaces the resource when you change this property.
    pub batch_import_meta_data_on_create: Option<::Value<bool>>,
    /// Property [`DataRepositoryPath`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-fsx-datarepositoryassociation.html#cfn-fsx-datarepositoryassociation-datarepositorypath).
    ///
    /// Update type: _Immutable_.
    /// AWS CloudFormation replaces the resource when you change this property.
    pub data_repository_path: ::Value<String>,
    /// Property [`FileSystemId`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-fsx-datarepositoryassociation.html#cfn-fsx-datarepositoryassociation-filesystemid).
    ///
    /// Update type: _Immutable_.
    /// AWS CloudFormation replaces the resource when you change this property.
    pub file_system_id: ::Value<String>,
    /// Property [`FileSystemPath`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-fsx-datarepositoryassociation.html#cfn-fsx-datarepositoryassociation-filesystempath).
    ///
    /// Update type: _Immutable_.
    /// AWS CloudFormation replaces the resource when you change this property.
    pub file_system_path: ::Value<String>,
    /// Property [`ImportedFileChunkSize`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-fsx-datarepositoryassociation.html#cfn-fsx-datarepositoryassociation-importedfilechunksize).
    ///
    /// Update type: _Mutable_.
    /// AWS CloudFormation doesn't replace the resource when you change this property.
    pub imported_file_chunk_size: Option<::Value<u32>>,
    /// Property [`S3`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-fsx-datarepositoryassociation.html#cfn-fsx-datarepositoryassociation-s3).
    ///
    /// Update type: _Mutable_.
    /// AWS CloudFormation doesn't replace the resource when you change this property.
    pub s3: Option<::Value<self::data_repository_association::S3>>,
    /// Property [`Tags`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-fsx-datarepositoryassociation.html#cfn-fsx-datarepositoryassociation-tags).
    ///
    /// Update type: _Mutable_.
    /// AWS CloudFormation doesn't replace the resource when you change this property.
...
impl ::serde::Serialize for DataRepositoryAssociationProperties {
    fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
        let mut map = ::serde::Serializer::serialize_map(s, None)?;
        if let Some(ref batch_import_meta_data_on_create) = self.batch_import_meta_data_on_create {
            ::serde::ser::SerializeMap::serialize_entry(&mut map, "BatchImportMetaDataOnCreate", batch_import_meta_data_on_create)?;
        }
        ::serde::ser::SerializeMap::serialize_entry(&mut map, "DataRepositoryPath", &self.data_repository_path)?;
        ::serde::ser::SerializeMap::serialize_entry(&mut map, "FileSystemId", &self.file_system_id)?;
        ::serde::ser::SerializeMap::serialize_entry(&mut map, "FileSystemPath", &self.file_system_path)?;
...
impl<'de> ::serde::Deserialize<'de> for DataRepositoryAssociationProperties {
    fn deserialize<D: ::serde::Deserializer<'de>>(d: D) -> Result<DataRepositoryAssociationProperties, D::Error> {
        struct Visitor;

        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            type Value = DataRepositoryAssociationProperties;

            fn expecting(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
                write!(f, "a struct of type DataRepositoryAssociationProperties")
            }

            fn visit_map<A: ::serde::de::MapAccess<'de>>(self, mut map: A) -> Result<Self::Value, A::Error> {
                let mut batch_import_meta_data_on_create: Option<::Value<bool>> = None;
                let mut data_repository_path: Option<::Value<String>> = None;
                let mut file_system_id: Option<::Value<String>> = None;
                let mut file_system_path: Option<::Value<String>> = None;
                let mut imported_file_chunk_size: Option<::Value<u32>> = None;
                let mut s3: Option<::Value<self::data_repository_association::S3>> = None;
                let mut tags: Option<::ValueList<::Tag>> = None;

                while let Some(__cfn_key) = ::serde::de::MapAccess::next_key::<String>(&mut map)? {
                    match __cfn_key.as_ref() {
                        "BatchImportMetaDataOnCreate" => {
                            batch_import_meta_data_on_create = ::serde::de::MapAccess::next_value(&mut map)?;
                        }
                        "DataRepositoryPath" => {
                            data_repository_path = ::serde::de::MapAccess::next_value(&mut map)?;
                        }
                        "FileSystemId" => {
                            file_system_id = ::serde::de::MapAccess::next_value(&mut map)?;
                        }
                        "FileSystemPath" => {
                            file_system_path = ::serde::de::MapAccess::next_value(&mut map)?;
                        }
                ...
                Ok(DataRepositoryAssociationProperties {
                    batch_import_meta_data_on_create: batch_import_meta_data_on_create,
                    data_repository_path: data_repository_path.ok_or(::serde::de::Error::missing_field("DataRepositoryPath"))?,
                    file_system_id: file_system_id.ok_or(::serde::de::Error::missing_field("FileSystemId"))?,
                    file_system_path: file_system_path.ok_or(::serde::de::Error::missing_field("FileSystemPath"))?,
...
impl ::Resource for DataRepositoryAssociation {
    type Properties = DataRepositoryAssociationProperties;
    const TYPE: &'static str = "AWS::FSx::DataRepositoryAssociation";
    fn properties(&self) -> &DataRepositoryAssociationProperties {
        &self.properties
    }
    fn properties_mut(&mut self) -> &mut DataRepositoryAssociationProperties {
        &mut self.properties
    }
}

impl ::private::Sealed for DataRepositoryAssociation {}

impl From<DataRepositoryAssociationProperties> for DataRepositoryAssociation {
    fn from(properties: DataRepositoryAssociationProperties) -> DataRepositoryAssociation {
        DataRepositoryAssociation { properties }
    }
}
...
pub mod data_repository_association {
    //! Property types for the `DataRepositoryAssociation` resource.

    /// The [`AWS::FSx::DataRepositoryAssociation.AutoExportPolicy`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-datarepositoryassociation-autoexportpolicy.html) property type.
    #[derive(Debug, Default)]
    pub struct AutoExportPolicy {
        /// Property [`Events`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-datarepositoryassociation-autoexportpolicy.html#cfn-fsx-datarepositoryassociation-autoexportpolicy-events).
        ///
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
    ...
    impl ::codec::SerializeValue for AutoExportPolicy {
        fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
            let mut map = ::serde::Serializer::serialize_map(s, None)?;
    ...
    impl ::codec::DeserializeValue for AutoExportPolicy {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(d: D) -> Result<AutoExportPolicy, D::Error> {
            struct Visitor;

            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                type Value = AutoExportPolicy;

                fn expecting(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
                    write!(f, "a struct of type AutoExportPolicy")
                }
    ...
    /// The [`AWS::FSx::DataRepositoryAssociation.AutoImportPolicy`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-datarepositoryassociation-autoimportpolicy.html) property type.
    #[derive(Debug, Default)]
    pub struct AutoImportPolicy {
        /// Property [`Events`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-datarepositoryassociation-autoimportpolicy.html#cfn-fsx-datarepositoryassociation-autoimportpolicy-events).
        ///
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub events: ::ValueList<String>,
    ...
    impl ::codec::SerializeValue for AutoImportPolicy {
        fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
            let mut map = ::serde::Serializer::serialize_map(s, None)?;
            ::serde::ser::SerializeMap::serialize_entry(&mut map, "Events", &self.events)?;
            ::serde::ser::SerializeMap::end(map)
    ...
    impl ::codec::DeserializeValue for AutoImportPolicy {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(d: D) -> Result<AutoImportPolicy, D::Error> {
            struct Visitor;

            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                type Value = AutoImportPolicy;

                fn expecting(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
                    write!(f, "a struct of type AutoImportPolicy")
                }
    ...
    /// The [`AWS::FSx::DataRepositoryAssociation.S3`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-datarepositoryassociation-s3.html) property type.
    #[derive(Debug, Default)]
    pub struct S3 {
        /// Property [`AutoExportPolicy`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-datarepositoryassociation-s3.html#cfn-fsx-datarepositoryassociation-s3-autoexportpolicy).
        ///
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub auto_export_policy: Option<::Value<AutoExportPolicy>>,
        /// Property [`AutoImportPolicy`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-datarepositoryassociation-s3.html#cfn-fsx-datarepositoryassociation-s3-autoimportpolicy).
        ///
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub auto_import_policy: Option<::Value<AutoImportPolicy>>,
    }

    impl ::codec::SerializeValue for S3 {
        fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
            let mut map = ::serde::Serializer::serialize_map(s, None)?;
            if let Some(ref auto_export_policy) = self.auto_export_policy {
                ::serde::ser::SerializeMap::serialize_entry(&mut map, "AutoExportPolicy", auto_export_policy)?;
            }
    ...
    impl ::codec::DeserializeValue for S3 {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(d: D) -> Result<S3, D::Error> {
            ...
            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(self, mut map: A) -> Result<Self::Value, A::Error> {
                    let mut auto_export_policy: Option<::Value<AutoExportPolicy>> = None;
                    let mut auto_import_policy: Option<::Value<AutoImportPolicy>> = None;

                    while let Some(__cfn_key) = ::serde::de::MapAccess::next_key::<String>(&mut map)? {
                        match __cfn_key.as_ref() {
                            "AutoExportPolicy" => {
                                auto_export_policy = ::serde::de::MapAccess::next_value(&mut map)?;
                            }
                            "AutoImportPolicy" => {
...
pub mod file_system {
    ...
    pub struct OntapConfiguration {
        ...
        /// Property [`HAPairs`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-filesystem-ontapconfiguration.html#cfn-fsx-filesystem-ontapconfiguration-hapairs).
        ///
        /// Update type: _Immutable_.
        /// AWS CloudFormation replaces the resource when you change this property.
        pub ha_pairs: Option<::Value<u32>>,
        ...
        /// Property [`ThroughputCapacityPerHAPair`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-filesystem-ontapconfiguration.html#cfn-fsx-filesystem-ontapconfiguration-throughputcapacityperhapair).
        ///
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub throughput_capacity_per_ha_pair: Option<::Value<u32>>,
    ...
    impl ::codec::SerializeValue for OntapConfiguration {
        fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
            ...
            if let Some(ref ha_pairs) = self.ha_pairs {
                ::serde::ser::SerializeMap::serialize_entry(&mut map, "HAPairs", ha_pairs)?;
            }
            ...
            if let Some(ref throughput_capacity_per_ha_pair) = self.throughput_capacity_per_ha_pair {
                ::serde::ser::SerializeMap::serialize_entry(&mut map, "ThroughputCapacityPerHAPair", throughput_capacity_per_ha_pair)?;
            }
            if let Some(ref weekly_maintenance_start_time) = self.weekly_maintenance_start_time {
                ::serde::ser::SerializeMap::serialize_entry(&mut map, "WeeklyMaintenanceStartTime", weekly_maintenance_start_time)?;
            }
        ...
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(d: D) -> Result<OntapConfiguration, D::Error> {
            ...
            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(self, mut map: A) -> Result<Self::Value, A::Error> {
                    ...
                    let mut ha_pairs: Option<::Value<u32>> = None;
                    ...
                    let mut throughput_capacity_per_ha_pair: Option<::Value<u32>> = None;
                    let mut weekly_maintenance_start_time: Option<::Value<String>> = None;
                    ...
                    while let Some(__cfn_key) = ::serde::de::MapAccess::next_key::<String>(&mut map)? {
                        match __cfn_key.as_ref() {
                            ...
                            "HAPairs" => {
                                ha_pairs = ::serde::de::MapAccess::next_value(&mut map)?;
                            }
                            "PreferredSubnetId" => {
                            ...
                            "ThroughputCapacityPerHAPair" => {
                                throughput_capacity_per_ha_pair = ::serde::de::MapAccess::next_value(&mut map)?;
                            }
                            "WeeklyMaintenanceStartTime" => {
                                weekly_maintenance_start_time = ::serde::de::MapAccess::next_value(&mut map)?;
                            }
    ...
    pub struct OpenZFSConfiguration {
        ...
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub disk_iops_configuration: Option<::Value<DiskIopsConfiguration>>,
        /// Property [`EndpointIpAddressRange`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-filesystem-openzfsconfiguration.html#cfn-fsx-filesystem-openzfsconfiguration-endpointipaddressrange).
        ///
        /// Update type: _Immutable_.
        /// AWS CloudFormation replaces the resource when you change this property.
        pub endpoint_ip_address_range: Option<::Value<String>>,
        ...
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub options: Option<::ValueList<String>>,
        /// Property [`PreferredSubnetId`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-filesystem-openzfsconfiguration.html#cfn-fsx-filesystem-openzfsconfiguration-preferredsubnetid).
        ///
        /// Update type: _Immutable_.
        /// AWS CloudFormation replaces the resource when you change this property.
        pub preferred_subnet_id: Option<::Value<String>>,
        ...
        /// Property [`RouteTableIds`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-filesystem-openzfsconfiguration.html#cfn-fsx-filesystem-openzfsconfiguration-routetableids).
        ///
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub route_table_ids: Option<::ValueList<String>>,
    ...
    pub struct WindowsConfiguration {
        ...
        /// AWS CloudFormation replaces the resource when you change this property.
        pub deployment_type: Option<::Value<String>>,
        /// Property [`DiskIopsConfiguration`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-filesystem-windowsconfiguration.html#cfn-fsx-filesystem-windowsconfiguration-diskiopsconfiguration).
        ///
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub disk_iops_configuration: Option<::Value<DiskIopsConfiguration>>,
...
pub mod volume {
    ...
    /// The [`AWS::FSx::Volume.AggregateConfiguration`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-volume-ontapconfiguration-aggregateconfiguration.html) property type.
    #[derive(Debug, Default)]
    pub struct AggregateConfiguration {
        /// Property [`Aggregates`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-volume-ontapconfiguration-aggregateconfiguration.html#cfn-fsx-volume-ontapconfiguration-aggregateconfiguration-aggregates).
        ///
        /// Update type: _Immutable_.
        /// AWS CloudFormation replaces the resource when you change this property.
        pub aggregates: Option<::ValueList<String>>,
        /// Property [`ConstituentsPerAggregate`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-volume-ontapconfiguration-aggregateconfiguration.html#cfn-fsx-volume-ontapconfiguration-aggregateconfiguration-constituentsperaggregate).
        ///
        /// Update type: _Immutable_.
        /// AWS CloudFormation replaces the resource when you change this property.
        pub constituents_per_aggregate: Option<::Value<u32>>,
    }

    impl ::codec::SerializeValue for AggregateConfiguration {
        fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
            let mut map = ::serde::Serializer::serialize_map(s, None)?;
            if let Some(ref aggregates) = self.aggregates {
                ::serde::ser::SerializeMap::serialize_entry(&mut map, "Aggregates", aggregates)?;
            }
            if let Some(ref constituents_per_aggregate) = self.constituents_per_aggregate {
                ::serde::ser::SerializeMap::serialize_entry(&mut map, "ConstituentsPerAggregate", constituents_per_aggregate)?;
            }
            ::serde::ser::SerializeMap::end(map)
        }
    }

    impl ::codec::DeserializeValue for AggregateConfiguration {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(d: D) -> Result<AggregateConfiguration, D::Error> {
            struct Visitor;

            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                type Value = AggregateConfiguration;

                fn expecting(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
                    write!(f, "a struct of type AggregateConfiguration")
                }

                fn visit_map<A: ::serde::de::MapAccess<'de>>(self, mut map: A) -> Result<Self::Value, A::Error> {
                    let mut aggregates: Option<::ValueList<String>> = None;
                    let mut constituents_per_aggregate: Option<::Value<u32>> = None;

                    while let Some(__cfn_key) = ::serde::de::MapAccess::next_key::<String>(&mut map)? {
                        match __cfn_key.as_ref() {
                            "Aggregates" => {
                                aggregates = ::serde::de::MapAccess::next_value(&mut map)?;
                            }
                            "ConstituentsPerAggregate" => {
                                constituents_per_aggregate = ::serde::de::MapAccess::next_value(&mut map)?;
                            }
                            _ => {}
                        }
                    }
    ...
    /// The [`AWS::FSx::Volume.AutocommitPeriod`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-volume-ontapconfiguration-snaplockconfiguration-autocommitperiod.html) property type.
    #[derive(Debug, Default)]
    pub struct AutocommitPeriod {
        /// Property [`Type`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-volume-ontapconfiguration-snaplockconfiguration-autocommitperiod.html#cfn-fsx-volume-ontapconfiguration-snaplockconfiguration-autocommitperiod-type).
        ///
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub r#type: ::Value<String>,
        /// Property [`Value`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-volume-ontapconfiguration-snaplockconfiguration-autocommitperiod.html#cfn-fsx-volume-ontapconfiguration-snaplockconfiguration-autocommitperiod-value).
        ///
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
    ...
    impl ::codec::SerializeValue for AutocommitPeriod {
        fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
            let mut map = ::serde::Serializer::serialize_map(s, None)?;
    ...
    impl ::codec::DeserializeValue for AutocommitPeriod {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(d: D) -> Result<AutocommitPeriod, D::Error> {
            struct Visitor;

            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                type Value = AutocommitPeriod;

                fn expecting(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
                    write!(f, "a struct of type AutocommitPeriod")
                }
    ...
    #[derive(Debug, Default)]
    pub struct OntapConfiguration {
        /// Property [`AggregateConfiguration`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-volume-ontapconfiguration.html#cfn-fsx-volume-ontapconfiguration-aggregateconfiguration).
        ///
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub aggregate_configuration: Option<::Value<AggregateConfiguration>>,
        /// Property [`CopyTagsToBackups`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-volume-ontapconfiguration.html#cfn-fsx-volume-ontapconfiguration-copytagstobackups).
        ///
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub copy_tags_to_backups: Option<::Value<String>>,
        ...
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub junction_path: Option<::Value<String>>,
        /// Property [`OntapVolumeType`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-volume-ontapconfiguration.html#cfn-fsx-volume-ontapconfiguration-ontapvolumetype).
        ///
        /// Update type: _Immutable_.
        /// AWS CloudFormation replaces the resource when you change this property.
        pub ontap_volume_type: Option<::Value<String>>,
        ...
        /// Property [`SizeInBytes`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-volume-ontapconfiguration.html#cfn-fsx-volume-ontapconfiguration-sizeinbytes).
        ///
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub size_in_bytes: Option<::Value<String>>,
        ...
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub size_in_megabytes: Option<::Value<String>>,
        /// Property [`SnaplockConfiguration`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-volume-ontapconfiguration.html#cfn-fsx-volume-ontapconfiguration-snaplockconfiguration).
        ///
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub snaplock_configuration: Option<::Value<SnaplockConfiguration>>,
        /// Property [`SnapshotPolicy`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-volume-ontapconfiguration.html#cfn-fsx-volume-ontapconfiguration-snapshotpolicy).
        ///
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub snapshot_policy: Option<::Value<String>>,
        ...
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub storage_efficiency_enabled: Option<::Value<String>>,
        ...
        /// Property [`VolumeStyle`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-volume-ontapconfiguration.html#cfn-fsx-volume-ontapconfiguration-volumestyle).
        ///
        /// Update type: _Immutable_.
        /// AWS CloudFormation replaces the resource when you change this property.
        pub volume_style: Option<::Value<String>>,
    }

    impl ::codec::SerializeValue for OntapConfiguration {
        fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
            let mut map = ::serde::Serializer::serialize_map(s, None)?;
            if let Some(ref aggregate_configuration) = self.aggregate_configuration {
                ::serde::ser::SerializeMap::serialize_entry(&mut map, "AggregateConfiguration", aggregate_configuration)?;
            }
            if let Some(ref copy_tags_to_backups) = self.copy_tags_to_backups {
                ::serde::ser::SerializeMap::serialize_entry(&mut map, "CopyTagsToBackups", copy_tags_to_backups)?;
            }
            if let Some(ref junction_path) = self.junction_path {
                ::serde::ser::SerializeMap::serialize_entry(&mut map, "JunctionPath", junction_path)?;
            }
            if let Some(ref ontap_volume_type) = self.ontap_volume_type {
                ::serde::ser::SerializeMap::serialize_entry(&mut map, "OntapVolumeType", ontap_volume_type)?;
            }
            ...
            if let Some(ref size_in_bytes) = self.size_in_bytes {
                ::serde::ser::SerializeMap::serialize_entry(&mut map, "SizeInBytes", size_in_bytes)?;
            }
            if let Some(ref size_in_megabytes) = self.size_in_megabytes {
                ::serde::ser::SerializeMap::serialize_entry(&mut map, "SizeInMegabytes", size_in_megabytes)?;
            }
            if let Some(ref snaplock_configuration) = self.snaplock_configuration {
                ::serde::ser::SerializeMap::serialize_entry(&mut map, "SnaplockConfiguration", snaplock_configuration)?;
            }
            if let Some(ref snapshot_policy) = self.snapshot_policy {
                ::serde::ser::SerializeMap::serialize_entry(&mut map, "SnapshotPolicy", snapshot_policy)?;
            }
            if let Some(ref storage_efficiency_enabled) = self.storage_efficiency_enabled {
                ::serde::ser::SerializeMap::serialize_entry(&mut map, "StorageEfficiencyEnabled", storage_efficiency_enabled)?;
            }
            ...
            if let Some(ref volume_style) = self.volume_style {
                ::serde::ser::SerializeMap::serialize_entry(&mut map, "VolumeStyle", volume_style)?;
            }
            ::serde::ser::SerializeMap::end(map)
        }
    }
    ...
    impl ::codec::DeserializeValue for OntapConfiguration {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(d: D) -> Result<OntapConfiguration, D::Error> {
            ...
            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                ...
                fn visit_map<A: ::serde::de::MapAccess<'de>>(self, mut map: A) -> Result<Self::Value, A::Error> {
                    let mut aggregate_configuration: Option<::Value<AggregateConfiguration>> = None;
                    let mut copy_tags_to_backups: Option<::Value<String>> = None;
                    let mut junction_path: Option<::Value<String>> = None;
                    let mut ontap_volume_type: Option<::Value<String>> = None;
                    let mut security_style: Option<::Value<String>> = None;
                    let mut size_in_bytes: Option<::Value<String>> = None;
                    let mut size_in_megabytes: Option<::Value<String>> = None;
                    let mut snaplock_configuration: Option<::Value<SnaplockConfiguration>> = None;
                    let mut snapshot_policy: Option<::Value<String>> = None;
                    ...
                    let mut volume_style: Option<::Value<String>> = None;

                    while let Some(__cfn_key) = ::serde::de::MapAccess::next_key::<String>(&mut map)? {
                        match __cfn_key.as_ref() {
                            "AggregateConfiguration" => {
                                aggregate_configuration = ::serde::de::MapAccess::next_value(&mut map)?;
                            }
                            "CopyTagsToBackups" => {
                                copy_tags_to_backups = ::serde::de::MapAccess::next_value(&mut map)?;
                            }
                            ...
                            "OntapVolumeType" => {
                                ontap_volume_type = ::serde::de::MapAccess::next_value(&mut map)?;
                            }
                            "SecurityStyle" => {
                                security_style = ::serde::de::MapAccess::next_value(&mut map)?;
                            }
                            "SizeInBytes" => {
                                size_in_bytes = ::serde::de::MapAccess::next_value(&mut map)?;
                            }
                            "SizeInMegabytes" => {
                                size_in_megabytes = ::serde::de::MapAccess::next_value(&mut map)?;
                            }
                            "SnaplockConfiguration" => {
                                snaplock_configuration = ::serde::de::MapAccess::next_value(&mut map)?;
                            }
                            "SnapshotPolicy" => {
                                snapshot_policy = ::serde::de::MapAccess::next_value(&mut map)?;
                            }
                            ...
                            "VolumeStyle" => {
                                volume_style = ::serde::de::MapAccess::next_value(&mut map)?;
                            }
                            _ => {}
                        }
                    }
    ...
    /// The [`AWS::FSx::Volume.RetentionPeriod`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-volume-retentionperiod.html) property type.
    #[derive(Debug, Default)]
    pub struct RetentionPeriod {
        /// Property [`Type`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-volume-retentionperiod.html#cfn-fsx-volume-retentionperiod-type).
        ///
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub r#type: ::Value<String>,
        /// Property [`Value`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-volume-retentionperiod.html#cfn-fsx-volume-retentionperiod-value).
        ///
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub value: Option<::Value<u32>>,
    ...
    /// The [`AWS::FSx::Volume.SnaplockConfiguration`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-volume-ontapconfiguration-snaplockconfiguration.html) property type.
    #[derive(Debug, Default)]
    pub struct SnaplockConfiguration {
        /// Property [`AuditLogVolume`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-volume-ontapconfiguration-snaplockconfiguration.html#cfn-fsx-volume-ontapconfiguration-snaplockconfiguration-auditlogvolume).
        ///
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub audit_log_volume: Option<::Value<String>>,
        /// Property [`AutocommitPeriod`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-volume-ontapconfiguration-snaplockconfiguration.html#cfn-fsx-volume-ontapconfiguration-snaplockconfiguration-autocommitperiod).
        ///
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub autocommit_period: Option<::Value<AutocommitPeriod>>,
        /// Property [`PrivilegedDelete`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-volume-ontapconfiguration-snaplockconfiguration.html#cfn-fsx-volume-ontapconfiguration-snaplockconfiguration-privilegeddelete).
        ///
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub privileged_delete: Option<::Value<String>>,
        /// Property [`RetentionPeriod`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-volume-ontapconfiguration-snaplockconfiguration.html#cfn-fsx-volume-ontapconfiguration-snaplockconfiguration-retentionperiod).
        ///
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub retention_period: Option<::Value<SnaplockRetentionPeriod>>,
        /// Property [`SnaplockType`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-volume-ontapconfiguration-snaplockconfiguration.html#cfn-fsx-volume-ontapconfiguration-snaplockconfiguration-snaplocktype).
        ///
        /// Update type: _Immutable_.
        /// AWS CloudFormation replaces the resource when you change this property.
        pub snaplock_type: ::Value<String>,
        /// Property [`VolumeAppendModeEnabled`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-volume-ontapconfiguration-snaplockconfiguration.html#cfn-fsx-volume-ontapconfiguration-snaplockconfiguration-volumeappendmodeenabled).
        ///
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub volume_append_mode_enabled: Option<::Value<String>>,
    }

    impl ::codec::SerializeValue for SnaplockConfiguration {
        fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
            let mut map = ::serde::Serializer::serialize_map(s, None)?;
            if let Some(ref audit_log_volume) = self.audit_log_volume {
                ::serde::ser::SerializeMap::serialize_entry(&mut map, "AuditLogVolume", audit_log_volume)?;
            }
            if let Some(ref autocommit_period) = self.autocommit_period {
                ::serde::ser::SerializeMap::serialize_entry(&mut map, "AutocommitPeriod", autocommit_period)?;
            }
            if let Some(ref privileged_delete) = self.privileged_delete {
                ::serde::ser::SerializeMap::serialize_entry(&mut map, "PrivilegedDelete", privileged_delete)?;
            }
            ...
            ::serde::ser::SerializeMap::serialize_entry(&mut map, "SnaplockType", &self.snaplock_type)?;
            if let Some(ref volume_append_mode_enabled) = self.volume_append_mode_enabled {
                ::serde::ser::SerializeMap::serialize_entry(&mut map, "VolumeAppendModeEnabled", volume_append_mode_enabled)?;
            }
            ::serde::ser::SerializeMap::end(map)
        }
    }

    impl ::codec::DeserializeValue for SnaplockConfiguration {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(d: D) -> Result<SnaplockConfiguration, D::Error> {
            struct Visitor;

            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                type Value = SnaplockConfiguration;

                fn expecting(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
                    write!(f, "a struct of type SnaplockConfiguration")
                }

                fn visit_map<A: ::serde::de::MapAccess<'de>>(self, mut map: A) -> Result<Self::Value, A::Error> {
                    let mut audit_log_volume: Option<::Value<String>> = None;
                    let mut autocommit_period: Option<::Value<AutocommitPeriod>> = None;
                    let mut privileged_delete: Option<::Value<String>> = None;
                    let mut retention_period: Option<::Value<SnaplockRetentionPeriod>> = None;
                    let mut snaplock_type: Option<::Value<String>> = None;
                    let mut volume_append_mode_enabled: Option<::Value<String>> = None;

                    while let Some(__cfn_key) = ::serde::de::MapAccess::next_key::<String>(&mut map)? {
                        match __cfn_key.as_ref() {
                            "AuditLogVolume" => {
                                audit_log_volume = ::serde::de::MapAccess::next_value(&mut map)?;
                            }
                            "AutocommitPeriod" => {
                                autocommit_period = ::serde::de::MapAccess::next_value(&mut map)?;
                            }
                            "PrivilegedDelete" => {
                                privileged_delete = ::serde::de::MapAccess::next_value(&mut map)?;
                            }
                            "RetentionPeriod" => {
                                retention_period = ::serde::de::MapAccess::next_value(&mut map)?;
                            }
                            "SnaplockType" => {
                                snaplock_type = ::serde::de::MapAccess::next_value(&mut map)?;
                            }
                            "VolumeAppendModeEnabled" => {
                                volume_append_mode_enabled = ::serde::de::MapAccess::next_value(&mut map)?;
                            }
                            _ => {}
                        }
                    }

                    Ok(SnaplockConfiguration {
                        audit_log_volume: audit_log_volume,
                        autocommit_period: autocommit_period,
                        privileged_delete: privileged_delete,
                        retention_period: retention_period,
                        snaplock_type: snaplock_type.ok_or(::serde::de::Error::missing_field("SnaplockType"))?,
    ...
    /// The [`AWS::FSx::Volume.SnaplockRetentionPeriod`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-volume-snaplockretentionperiod.html) property type.
    #[derive(Debug, Default)]
    pub struct SnaplockRetentionPeriod {
        /// Property [`DefaultRetention`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-volume-snaplockretentionperiod.html#cfn-fsx-volume-snaplockretentionperiod-defaultretention).
        ///
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub default_retention: ::Value<RetentionPeriod>,
        /// Property [`MaximumRetention`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-volume-snaplockretentionperiod.html#cfn-fsx-volume-snaplockretentionperiod-maximumretention).
        ///
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub maximum_retention: ::Value<RetentionPeriod>,
        /// Property [`MinimumRetention`](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-fsx-volume-snaplockretentionperiod.html#cfn-fsx-volume-snaplockretentionperiod-minimumretention).
        ///
        /// Update type: _Mutable_.
        /// AWS CloudFormation doesn't replace the resource when you change this property.
        pub minimum_retention: ::Value<RetentionPeriod>,
    }

    impl ::codec::SerializeValue for SnaplockRetentionPeriod {
        fn serialize<S: ::serde::Serializer>(&self, s: S) -> Result<S::Ok, S::Error> {
            let mut map = ::serde::Serializer::serialize_map(s, None)?;
            ::serde::ser::SerializeMap::serialize_entry(&mut map, "DefaultRetention", &self.default_retention)?;
            ::serde::ser::SerializeMap::serialize_entry(&mut map, "MaximumRetention", &self.maximum_retention)?;
            ::serde::ser::SerializeMap::serialize_entry(&mut map, "MinimumRetention", &self.minimum_retention)?;
            ::serde::ser::SerializeMap::end(map)
        }
    }

    impl ::codec::DeserializeValue for SnaplockRetentionPeriod {
        fn deserialize<'de, D: ::serde::Deserializer<'de>>(d: D) -> Result<SnaplockRetentionPeriod, D::Error> {
            struct Visitor;

            impl<'de> ::serde::de::Visitor<'de> for Visitor {
                type Value = SnaplockRetentionPeriod;

                fn expecting(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
                    write!(f, "a struct of type SnaplockRetentionPeriod")
                }

                fn visit_map<A: ::serde::de::MapAccess<'de>>(self, mut map: A) -> Result<Self::Value, A::Error> {
                    let mut default_retention: Option<::Value<RetentionPeriod>> = None;
                    let mut maximum_retention: Option<::Value<RetentionPeriod>> = None;
                    let mut minimum_retention: Option<::Value<RetentionPeriod>> = None;
                    ...
                    while let Some(__cfn_key) = ::serde::de::MapAccess::next_key::<String>(&mut map)? {
                        match __cfn_key.as_ref() {
                            ...
                            "MaximumRetention" => {
                                maximum_retention = ::serde::de::MapAccess::next_value(&mut map)?;
                            }
                            "MinimumRetention" => {
                                minimum_retention = ::serde::de::MapAccess::next_value(&mut map)?;
                            }
                            _ => {}
                        }
                    }

                    Ok(SnaplockRetentionPeriod {
                        default_retention: default_retention.ok_or(::serde::de::Error::missing_field("DefaultRetention"))?,
                        maximum_retention: maximum_retention.ok_or(::serde::de::Error::missing_field("MaximumRetention"))?,
                        minimum_retention: minimum_retention.ok_or(::serde::de::Error::missing_field("MinimumRetention"))?,
                    })
                }
            }
